 ...
 * `20260603041422` token is stamped at build time by
 ...
 *
 * The literal token must stay exactly `20260603041422` so the stamp script's
 * replace finds it; in dev (unstamped) it falls back to "dev", which still
 * produces valid, namespaced cache names.
 */
const BUILD_ID = "20260603041422".startsWith("__") ? "dev" : "20260603041422";
