 ...
 * `20260613215602` token is stamped at build time by
 ...
 *
 * The literal token must stay exactly `20260613215602` so the stamp script's
 * replace finds it; in dev (unstamped) it falls back to "dev", which still
 * produces valid, namespaced cache names.
 */
const BUILD_ID = "20260613215602".startsWith("__") ? "dev" : "20260613215602";
