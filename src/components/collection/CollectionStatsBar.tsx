...
function Stat({ label, value, accent = "cyan" }: { label: string; value: string; accent?: Accent }) {
  return (
    <div className="flex items-baseline gap-2">
      <span className="font-osd text-[10px] uppercase tracking-[0.16em] text-fg-faint">{label}</span>
...
export function CollectionStatsBar({
  ...
  return (
    ...
    >
      <span className="font-osd text-[10px] uppercase tracking-[0.2em] text-cyan">▸ COLLECTION</span>
