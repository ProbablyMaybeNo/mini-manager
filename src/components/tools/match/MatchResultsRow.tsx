...
export function MatchResultsRow({ result, onUse }: Props) {
  ...
  return (
    <div
      role="row"
      className="grid grid-cols-[24px_1fr_72px_56px] items-center gap-2 px-2 py-1.5 border-b border-[var(--color-border)] hover:bg-[color-mix(in_srgb,var(--color-fg)_4%,transparent)]"
    >
      <span
        role="cell"
        aria-hidden
