...
export function PublicHeader() {
  const linkClass =
    "rounded-[6px] px-1 py-0.5 font-h1 text-h1 uppercase tracking-[0.18em] text-fg transition-colors duration-150 hover:text-cyan focus:outline-none focus-visible:text-cyan";
  return (
