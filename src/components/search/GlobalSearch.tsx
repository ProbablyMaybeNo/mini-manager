...
export function GlobalSearch() {
  ...
  const commands = useMemo<ReadonlyArray<Command>>(() => {
    ...
    return [
      ...
      { id: "go-focus", label: "Go to Focus", keywords: "focus painting bench recipe stopwatch inspo planner timer", href: "/projects#focus", run: go("/projects#focus") },
      ...
      { id: "go-collection", label: "Go to Collection", keywords: "collection collections wishlist shopping paints models owned", href: "/collection", run: go("/collection") },
