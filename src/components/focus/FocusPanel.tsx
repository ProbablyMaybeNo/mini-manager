              ...
              >
                <header className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-2xs text-[var(--color-fg-subtle)]">
                    {zone.steps.length} step{zone.steps.length === 1 ? "" : "s"}
                  </span>
                </header>
                    ...
                    {zone.steps.map((step) => (
                      ...
                      >
                        ...
                        <div className="min-w-0 space-y-1">
                          <p className="font-mono text-xs uppercase tracking-wider text-[var(--color-fg)] truncate">
                            {step.paintLabel ??
